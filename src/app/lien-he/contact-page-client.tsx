...
export function ContactPageClient() {
  ...
  const handleIframeLoad = () => {
    // iframe sẽ load sau khi form submit xong
    if (isSubmitting) {
        ...
        <div className="relative z-10 flex min-h-[300px] md:min-h-[460px] flex-col items-center justify-center gap-4 md:gap-6 text-center px-6 py-12 md:py-20">
          ...
          <AnimateOnScroll animation="fadeInUp" delay={0.2} duration={0.8}>
            <p className="max-w-3xl text-sm md:text-base text-white lg:text-xl font-normal px-4">
              Quy trình trọn gói thiết kế & thi công nội thất bạn chỉ việc chờ
              chìa khóa
            </p>
          </AnimateOnScroll>
        </div>
        ...
        <div className="grid gap-8 md:gap-12 grid-cols-1 md:grid-cols-12">
          ...
          >
            <div className="space-y-4 md:space-y-6 md:col-span-6 flex flex-col justify-center">
              <p className="text-sm md:text-base text-secondary leading-relaxed">
                ...
                nhất cho từng nhu cầu, để mỗi khách hàng đều nhận được không
                gian đúng như mong đợi.
              </p>
              <p className="text-sm md:text-base text-secondary leading-relaxed">
                Với xưởng sản xuất riêng, nguồn cung ổn định cùng đội ngũ thi
                công chuyên nghiệp, Anvie có thể phục vụ xuyên suốt cả ngày
                thường, lễ tết hay cao điểm.
              </p>
              <p className="text-sm md:text-base text-secondary leading-relaxed">
                Nếu trong quá trình sử dụng có vấn đề phát sinh, Anvie sẵn sàng
                bảo hành và hỗ trợ kịp thời, để bạn thật sự an tâm khi lựa chọn
                chúng tôi.
              </p>
            </div>
          </AnimateOnScroll>
          ...
          >
            <div className="bg-[#FFF3E5] p-4 md:p-6 md:col-span-6">
              ...
              {/* Form submit trực tiếp vào Google Form / Google Sheets */}
              <form
                ref={formRef}
                className="space-y-3 md:space-y-4"
                // Gửi trực tiếp vào Google Form gắn với Google Sheet
                action="https://docs.google.com/forms/u/0/d/1cf4ukYVJEB1HUBfYYFa-yD1A4jicVMiEMIytETHnfzY/formResponse"
                method="POST"
              ...
              >
                ...
                <p className="text-xs md:text-sm text-secondary">
                  Anvie Home sẽ liên hệ lại trong vòng 30 phút đến 1 giờ từ khi
                  gửi thông tin
                </p>
                <button
                  type="submit"
              ...
              {/* Iframe ẩn để tránh redirect người dùng ra khỏi website */}
              <iframe
                name="hidden_iframe"
                ref={iframeRef}
                style={{ display: "none" }}
      ...
      {isSubmitted && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40 px-4">
          <div className="bg-white rounded-lg max-w-sm w-full p-6 shadow-lg text-center">
            ...
            <p className="text-sm md:text-base text-secondary mb-5">
              Anvie Home đã ghi nhận thông tin của bạn. Chúng tôi sẽ liên hệ lại
              trong thời gian sớm nhất.
            </p>
            <button
              onClick={closePopup}
              className="w-full bg-primary text-white px-4 py-2 md:py-3 text-sm md:text-base font-semibold hover:bg-terracotta-600 transition cursor-pointer"
            >
              Đóng
            </button>
          </div>

...
export function ProjectForm({ initialData, docId }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const slugConflict = existingProjects.docs.some((d) => d.id !== docId);
      if (slugConflict) {
      ...
      let errorMessage = isEdit ? "Lỗi khi cập nhật dự án" : "Lỗi khi tạo dự án";
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="bg-white rounded-lg border border-stone-200 p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">Địa điểm</label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">Quy mô</label>
                <input
                  type="text"
                  value={formData.area}
                  onChange={(e) =>
          ...
          <div className="bg-white rounded-lg border border-stone-200 p-6">
            <h2 className="text-xl font-semibold text-stone-900 mb-4">Nội dung dự án</h2>
            <TipTapEditor

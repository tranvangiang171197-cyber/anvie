...
export function ServicesSection() {
  ...
  return (
    <section className="space-y-6 xl:w-[1170px] mx-auto px-4 md:px-0 py-16">
      ...
      <div className="md:hidden w-screen -mx-4 overflow-x-auto scrollbar-hide" style={{ WebkitOverflowScrolling: 'touch' }}>
        <div className="flex gap-6 w-max px-4 pb-4">
              ...
              <div className="absolute inset-x-0 bottom-0 px-6 pb-8 text-white">
                <div className="flex items-end justify-between gap-4 flex-row">
                  <div className="space-y-2 flex-1 text-left">
                    ...
                    <div className="w-10 h-10 rounded-full bg-transparent flex items-center justify-center border border-white mt-2">
      ...
      <div className="hidden md:grid gap-6 grid-cols-4 w-full">
        {services.map((service, index) => {
          ...
          return (
            <div
              ...
              className={`relative z-0 transition-all duration-500 ease-in-out w-auto ${
                isHovered || isDefault
                  ? "col-span-2"
                  : "col-span-1"
